...
import (
	...
	"github.com/klone/operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(klonev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "62b2f990.klone.io",
	...
	if err := (&controller.KloneClusterReconciler{
